...
namespace XILINX_DPI { 
	...
	void dpiInitialize()
	{
		DPIAllocateSVCallerInfo(2) ;
		DPISetCallerName(0, "/home/gexl/Desktop/test2/RecoNIC/sim/src/rn_tb_2rdma_top.sv") ;
		DPISetCallerLine(0, 33) ;
		DPISetCallerOffset(0, 243736) ;
		DPISetCallerName(1, "/home/gexl/Desktop/test2/RecoNIC/sim/src/rn_tb_2rdma_top.sv") ;
		DPISetCallerLine(1, 42) ;
		DPISetCallerOffset(1, 243864) ;
		DPIAllocateDPIScopes(2) ;
		DPISetDPIScopeFunctionName(0, "simbricks_init") ;
		DPISetDPIScopeHierarchy(0, "rn_tb_2rdma_top(SIMBRICKS_PCI_SOCKET=\"/workspaces/simbricks/experiments/out/reconic-qemu/1/dev.pci.client.rec_client\",SHM_PATH=\"/workspaces/simbricks/experiments/out/reconic-qemu/1/dev.shm.client.rec_client\")") ;
		DPIRelocateDPIScopeIP(0, (char*)(0x1623f98)) ;
		DPISetDPIScopeFunctionName(1, "simbricks_is_exit") ;
		DPISetDPIScopeHierarchy(1, "rn_tb_2rdma_top(SIMBRICKS_PCI_SOCKET=\"/workspaces/simbricks/experiments/out/reconic-qemu/1/dev.pci.client.rec_client\",SHM_PATH=\"/workspaces/simbricks/experiments/out/reconic-qemu/1/dev.shm.client.rec_client\")") ;
		DPIRelocateDPIScopeIP(1, (char*)(0x1623f98)) ;
	}
