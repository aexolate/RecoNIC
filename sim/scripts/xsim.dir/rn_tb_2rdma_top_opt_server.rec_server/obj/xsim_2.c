...
namespace XILINX_DPI { 
	...
	void dpiInitialize()
	{
		...
		DPISetCallerOffset(0, 1080) ;
		DPISetCallerName(1, "/home/gexl/Desktop/test2/RecoNIC/sim/src/rn_tb_2rdma_top_remote.sv") ;
		DPISetCallerLine(1, 53) ;
		DPISetCallerOffset(1, 1080) ;
		DPISetCallerName(2, "/home/gexl/Desktop/test2/RecoNIC/sim/src/rn_tb_2rdma_top_remote.sv") ;
		DPISetCallerLine(2, 63) ;
		DPISetCallerOffset(2, 1208) ;
		DPIAllocateDPIScopes(3) ;
		DPISetDPIScopeFunctionName(0, "simbricks_init") ;
		DPISetDPIScopeHierarchy(0, "rn_tb_2rdma_top_remote(SIMBRICKS_PCI_SOCKET=\"/workspaces/simbricks/experiments/out/reconic-qemu/1/dev.pci.server.rec_server\",SHM_PATH=\"/workspaces/simbricks/experiments/out/reconic-qemu/1/dev.shm.server.rec_server\")") ;
		DPIRelocateDPIScopeIP(0, (char*)(0x31d8)) ;
		DPISetDPIScopeFunctionName(1, "simbricks_is_exit") ;
		DPISetDPIScopeHierarchy(1, "rn_tb_2rdma_top_remote(SIMBRICKS_PCI_SOCKET=\"/workspaces/simbricks/experiments/out/reconic-qemu/1/dev.pci.server.rec_server\",SHM_PATH=\"/workspaces/simbricks/experiments/out/reconic-qemu/1/dev.shm.server.rec_server\")") ;
		DPIRelocateDPIScopeIP(1, (char*)(0x31d8)) ;
		DPISetDPIScopeFunctionName(2, "init_shared_memory") ;
		DPISetDPIScopeHierarchy(2, "rn_tb_2rdma_top_remote(SIMBRICKS_PCI_SOCKET=\"/workspaces/simbricks/experiments/out/reconic-qemu/1/dev.pci.server.rec_server\",SHM_PATH=\"/workspaces/simbricks/experiments/out/reconic-qemu/1/dev.shm.server.rec_server\")") ;
		DPIRelocateDPIScopeIP(2, (char*)(0x31d8)) ;
	}
