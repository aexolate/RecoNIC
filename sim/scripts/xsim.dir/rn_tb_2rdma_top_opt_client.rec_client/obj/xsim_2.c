...
namespace XILINX_DPI { 
	...
	void dpiInitialize()
	{
		...
		DPIRelocateDPIScopeIP(0, (char*)(0x3348)) ;
		...
		DPIRelocateDPIScopeIP(1, (char*)(0x3348)) ;
		...
		DPIRelocateDPIScopeIP(2, (char*)(0x3348)) ;
	}
