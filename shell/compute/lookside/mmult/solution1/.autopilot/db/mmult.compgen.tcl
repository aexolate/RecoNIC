...
set ID 891
set hasByteEnable 0
set MemName mmult_localA_RAM_AUTO_1R1W
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    is_flushable 0 \ 
    mem_style block \ 
    name {mmult_systolic_m_axi} \
} "
} else {
puts "@W \[IMPL-110\] Cannot find AXI interface model in the library. Ignored generation of AXI interface for 'systolic'"
}
}

if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler mmult_systolic_m_axi BINDTYPE interface TYPE interface_m_axi
}
